...
test('only a complete evidenced external review can validate',()=>{
 const review=structuredClone(template);review.status='approved';review.reviewer={name:'External Reviewer',affiliation:'Independent',role:'aviation-domain reviewer',reviewedAt:'2026-09-18'};
