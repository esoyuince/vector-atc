...
export default function ProcedureInfo({state,flight,language}){
 ...
 <p>{en?'Holding fix, inbound course and turn direction come from charts; 60/90-second legs (at/below vs above 14,000 ft) and rate-one turns are demo assumptions.':'Bekleme noktası, giriş doğrultusu ve dönüş yönü haritalardan; bir dakikalık bacaklar ve saniyede 3° dönüş demo varsayımıdır.'}</p>
